...
echo ========================================
echo VFT_SMF V3 - Environment State Visualizer Build Script
echo ========================================
...
set SOURCE_FILE=visualize_environment_state.cpp
set OUTPUT_EXE=visualize_environment_state.exe
